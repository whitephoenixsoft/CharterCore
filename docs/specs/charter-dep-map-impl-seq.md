...
- identity, scope, purpose, and version lineage
...
| Legitimacy Engine | none (or abstract persistence contracts only) | Runtime, CCS, CCare, CLL, CAE, CGL, CRS |
| Runtime Layer | Legitimacy Engine, Persistence Layer | CCare, CLL, CAE, CGL |
| CCS | Runtime outputs, Persistence abstractions | CCare, CLL, CAE, CGL |
| Commit Store | CCS, Persistence Layer | Runtime semantics, CAE, CGL |
| CCare | CCS, Commit Store, Runtime artifacts | CLL, CAE, CGL |
| CLL | CCS, Commit Store, Runtime artifacts | CCare, CAE, CGL |
| CAE | CCS, Commit Store, CCare, CLL | CGL, CRS |
| CGL | CAE, CCare, CLL, CCS, Commit Store | CRS execution semantics |
| CRS | CCS, Persistence primitives | Runtime, CCare, CLL, CAE, CGL |
...
## 6.5 Export Composition (NEW)

Exports are:

- explicit packages of commit artifacts
- derived from Commit Store (not runtime state directly)
...
- be archived
- be pushed to Relay
- be re-imported through baseline review
...
## Phase 3 — Commit Substrate + Archive (UPDATED)
...
## IM-04 — Do Not Collapse Runtime and Commit Store (NEW)
