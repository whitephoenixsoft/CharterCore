...
Breakouts are isolated by design. They do not:
...
> **Receipt Note:** Closure of a breakout emits an **Exploration Receipt** capturing participants, artifact IDs, and explicit end-state.
...
> **Receipt Note:** Deliberate closure emits an **Exploration Receipt** capturing participants, all produced artifacts, and explicit end-state (SYNTHESIZED or ABANDONED).
