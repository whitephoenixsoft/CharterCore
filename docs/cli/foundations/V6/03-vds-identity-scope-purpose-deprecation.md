...
## 1. What Charter Observes

Charter focuses on **decisions, commitments, and declared areas of responsibility**.  
...
An identity does **not** refer to:

- A person or individual role (people exist within identities)  
- A single project, deployment, or temporary task  
- A system or software component  

These exist **within** identities, but they do not define them.

---

## 3. Scope and Domain

Every identity must declare:
...
## 4. Purpose and Change

Each identity has **one active purpose at a time**.  
...
**Changing purpose does not replace identity**. Identity evolves only when:

- Scope or responsibilities are explicitly added or removed  
- Features or responsibilities are removed irreversibly  

These are **evolutionary changes**, not rollbacks.

---

## 5. Deprecation and Abandonment

Charter areas may contain work in three states:

### Active
- Work contributes to current purpose and intent  
- Identity, scope, and purpose are coherent  
...
Clear identity, scope, and purpose:
...
## 7. Observing Misalignment and Change

Charter encourages reflection when work diverges from declared intent:

- Does this area need clarified purpose?  
- Has scope changed without explicit acknowledgement?  
- Should deprecated work be reassigned, updated, or consciously released?  
...
## 8. Conflict Without Coercion

When multiple areas have conflicting intents:

- Conflicts are **explicit and visible**  
- No party is framed as disobedient  
- No authority is forced to intervene  

Questions to explore:

- Which intent should take priority, if any?  
- Are the intents meant to coexist?  
- Is the purpose underspecified or outdated?  

Conflict becomes **legible, not political**.

---

## 9. Federation and Scale

Most large federated systems fail because:

- Identity is implicit  
- Change is silent  
- Deprecation is hidden  
- Accountability becomes moralized  
...
Charter **is not** a management framework, a performance metric, or an authority structure.  
