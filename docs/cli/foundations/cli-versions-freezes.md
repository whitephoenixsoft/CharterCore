# Charter Interfaces — Version Freezes & Evolution Plan (V1–V6)

Status: FROZEN (through V3)  
Scope: Charter interaction layers (CLI → Library → Guidance → Federation)  
...
It applies VDS and VLS lessons to Charter, enabling:
- Multi-area visibility
- Honest self-reporting
- Legitimacy-preserving roll-ups
- Human-chosen cadence

V6 adds:
- Charter area federation
...
- Area references as the connective tissue across layers
