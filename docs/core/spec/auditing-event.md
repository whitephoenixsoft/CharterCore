Excellent. Here is #2 — ENG-AUD, written in the same locked, engine-internal RFC style.
This one is foundational — it’s what makes Charter defensible years later.
...
When you’re ready, #3 should be:
ENG-REF — Reference Store Specification
That will finally lock:
Area heads
Active authority
Active scope
Session discovery
Context switching
Just say “#3” when you want it.