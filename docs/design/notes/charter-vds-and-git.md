...
This is not a feature proposal. It is a way of thinking about decisions as first-class artifacts.
...
These questions emerge naturally as systems scale. They are not workflow failures. They are missing decision memory.
...
Git records the *effects* of these decisions. It does not record their *legitimacy*.  
As a result:
...
Where Git answers: “What changed?”  
Charter answers: “Why was this allowed?”
...
Nothing breaks. Nothing is replaced. Context is added.
...
- Teams can separate state from legitimacy
...
## Final Thought
This future does not require permission to imagine.